...
test.describe("Make appointment", () => {
  ...
  await page.goto("https://katalon-demo-cura.herokuapp.com/",{timeout:10_000});//will run before the config navigationTimeout
   ...
   */
  let fulllpageLoginScreesht=await page.screenshot({fullPage:true});
  await testInfo.attach("login page",{
    body:fulllpageLoginScreesht,
